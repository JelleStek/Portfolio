...
final class Facade
{
    ...
    private function copyFiles(string $target): void
    {
        ...
        copy($this->templatePath . 'scss/bootstrap.min.scss', $dir . 'bootstrap.min.scss');
        copy($this->templatePath . 'scss/nv.d3.min.scss', $dir . 'nv.d3.min.scss');
        copy($this->templatePath . 'scss/style.scss', $dir . 'style.scss');
        copy($this->templatePath . 'scss/custom.scss', $dir . 'custom.scss');
        copy($this->templatePath . 'scss/octicons.scss', $dir . 'octicons.scss');
