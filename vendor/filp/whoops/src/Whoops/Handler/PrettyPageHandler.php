...
class PrettyPageHandler extends Handler
{
    ...
    /**
     * The name of the custom scss file.
     *
     * @var string|null
     */
    ...
    public function handle()
    {
        ...
        $cssFile      = $this->getResource("scss/whoops.base.scss");
        $zeptoFile    = $this->getResource("js/zepto.min.js");
        $prismJs = $this->getResource("js/prism.js");
        $prismCss = $this->getResource("scss/prism.scss");
    ...
    /**
     * Adds a custom scss file to be loaded.
     *
