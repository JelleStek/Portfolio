...
abstract class HttpClientTestCase extends TestCase
{
    ...
    public function testInformationalResponseStream()
    {
        ...
        $this->assertSame(['</style.scss>; rel=preload; as=style', '</script.js>; rel=preload; as=script'], $chunks[0]->getInformationalStatus()[1]['link']);
        ...
        $this->assertContains('Link: </style.scss>; rel=preload; as=style', $response->getInfo('response_headers'));
    }
